 ...
 * File Built by Zen Cart Installer on Tue Jul 26 2022 18:28:51
 */
 ...
 */
define('HTTP_CATALOG_SERVER', 'http://localhost:8100');
define('HTTPS_CATALOG_SERVER', 'https://localhost:8100');
...
define('DB_SERVER', 'mariadb-zencart');  // address of your db server
define('DB_SERVER_USERNAME', 'zencart');
define('DB_SERVER_PASSWORD', 'zencart');
define('DB_DATABASE', 'zencart_db');
